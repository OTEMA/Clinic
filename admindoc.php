...
$con->query("DELETE FROM doctor WHERE docid = '$_GET[docid]'");
$resapp = $con->query("SELECT * FROM doctor");
?>
...
<div id="container">
  <div class="wrapper">
    <div id="content">
      ...
      <table width="1009" border="1" bgcolor="124240">
        <tr>
          ...
          while($row1 = mysqli_fetch_array($resapp))
  {
	  ...
	  ?>
        <tr>
          ...
          <td width="57"><a href="admindocprofile.php?docids=<?php echo $row1[docid]; ?>"><img src="images/icons/Actions-document-edit-icon.png" alt="" width="32" height="32"></a></td>
