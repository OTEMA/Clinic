...
if (isset($_POST["submitupd"])) {
    ...
    $resrec = $con->query("UPDATE admin SET adminname='$_POST[adminname]', contactno='$_POST[contactno]',emailid='$_POST[emailid]',password ='$pwd'  WHERE adminid = '$_POST[adminid]' ");
}


$resultpatientrec = $con->query("SELECT * FROM admin");
