 ...
 if(isset($_SESSION["empid"]) && $_SESSION["usertype"] == "EMPLOYEE" )
{
	...
	?>
	<br>
	<p><center><img src="images/demo/receptionist (2).jpg" alt="" style="height:300px;width:450px;border-radius:15px;float:left"  /></center></p>
...
?>
      ...
      <p>
      <center>  <img src="images/demo/receptionist (2).jpg" alt="" width="280" height="183" /></center></p>
