    ...
    <div class="wrapper">
        <div id="content">
            ...
            if (isset($_SESSION["adminid"]) && $_SESSION["usertype"] == "ADMIN") {
                ...
                echo "You are now operating the Administrator account <br>";
                ?>
                <br>
                <p><center><img src="images/images7GNT63FV.jpg" alt="" style="height:300px;width:450px;border-radius:15px;float:left"  /></center></p>
