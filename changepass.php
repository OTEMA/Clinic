...
$sql = mysqli_query("SELECT * FROM patient WHERE patid = '$_POST[loginid1]' AND password='$pwd'");
$count =  mysqli_num_rows($sql);
	if($count == 1)
	{
	$resrec= mysqli_query("UPDATE patient SET password='$_POST[newpass]' WHERE patid = '$pwd' ");
