...
<?php
      $resapp = mysqli_query("SELECT * FROM patient where patid='$_POST[patid]'");
  ...
  $patientfname = $row11a["patfname"];
	$patlname = $row11a["patlname"];
      ...
      <p><strong> Treatment: </strong> </p><table width="533" border="1" bgcolor="124240">
    <tr>
          ...
          <?php
		   $resapprec = mysqli_query("SELECT * FROM appointment where patid='$_POST[patid]'");
		       $ik=0;
		 ...
		 $appids[$ik] =  $row11b["appointid"];
					...
					for($kk=0; $kk<$ik; $kk++ )
					{
$restrek = mysqli_query("SELECT * FROM treatment where appointid ='$appids[$kk]'");			
	  ...
	  ?>
          <tr>
            ...
            <td><?php echo $row1b["appointid"]; ?><td>&nbsp;<?php echo $row1b["docid"]; 
			 $respacdoc = mysqli_query("SELECT * FROM doctor where docid='$row1b[docid]'");
        ...
        <table width="533" border="1" bgcolor="124240">
          <tr>
          ...
          <?php
		   $kabrec= mysqli_query("SELECT * FROM labtest where patid='$_POST[patid]'");
          while($rowlab = mysqli_fetch_array($kabrec))
  {
	  ...
	  ?>
          <tr>
            ...
            <td><?php 
			 $respac = mysqli_query("SELECT * FROM testtype where ttypeid ='$rowlab[ttypeid]'");
