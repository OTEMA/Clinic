...
<?php 
include("menu.php");
mysqli_query("DELETE FROM appointment where appointid='$_GET[appiddel]'");
$resapp = mysqli_query("SELECT * FROM appointment where patid='$_SESSION[patid]'");
?>
...
<div id="container">
  <div class="wrapper">
    <div id="content">
      ...
      <h1>Appointments</h1>
      <table width="605" border="1" bgcolor="124240">
      <tr>
