...
$sql = mysqli_query("SELECT * FROM doctor WHERE docid = '$_POST[loginid1]' AND password='$pwd'");
$count =  mysqli_num_rows($sql);
	if($count == 1)
	{
	$resrec= mysqli_query("UPDATE doctor SET password='$_POST[newpass]' WHERE docid = '$pwd' ");
...
<input type="text" name="loginid1" id="textfield" class="validate[required,custom[onlyNumberSp]] text-input" value="<?php echo $_SESSION["docid"]; ?>" readonly>
