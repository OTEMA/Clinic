...
$resDapprec = mysqli_query("SELECT * FROM appointment WHERE docid='$_SESSION[appdocid]' AND patid ='$_SESSION[patid]' AND adate='$appdater'");
$appalrdytakn = mysqli_num_rows($resDapprec);

$resDapp1 = mysqli_query("SELECT * FROM appointment WHERE docid='$_SESSION[appdocid]' AND atime='$wordChunks[$i]' AND adate='$appdater'");
$resDapp = mysqli_query("SELECT * FROM timings WHERE docid='$_SESSION[appdocid]'");
$resDapp = mysqli_query("SELECT * FROM timings WHERE docid='$_SESSION[appdocid]'");
...
{
		$resDapp1 = mysqli_query("SELECT * FROM appointment WHERE docid='$_SESSION[appdocid]' AND atime='$wordChunks[$i]' AND adate='$appdater'");
		while($row12t = mysqli_fetch_array($resDapp1))
  			{
...
$apptakenrec = mysqli_query("SELECT * FROM appointment WHERE docid='$_SESSION[appdocid]'");
