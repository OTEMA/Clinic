...
$result = mysqli_query("SELECT MAX(empid) FROM employee");
...
$sql="INSERT INTO employee(empid, password, empname, designation, address, contactno, emailid) VALUES ('$_POST[efn2]','$_POST[password]','$_POST[efn] $_POST[emn] $_POST[eln]' ,'$_POST[desig]','$_POST[add]','$_POST[contact]','$_POST[emailid]')";
...
$maxpatid = $row[0];
	...
	$emprec = mysqli_query("SELECT * FROM employee where empid ='$maxpatid'");
while($row = mysqli_fetch_array($emprec))
  	{
