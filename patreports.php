...
$resapp123 = mysqli_query("SELECT * FROM labtest where patid  ='$_SESSION[patid]'");
?>
...
<div id="container">
  <div class="wrapper">
    <div id="content">
      ...
      <table width="707" border="1" bgcolor="124240">
        <tr>
          ...
          while($row1 = mysqli_fetch_array($resapp123))
  {
	  ?>
          <tr>
            ...
            <td> <?php
            $resapp1234 = mysqli_query("SELECT * FROM employee where empid   ='$row1[empid]'");
			 while($row12 = mysqli_fetch_array($resapp1234))
  			 {
 				echo $row12["empname"];
 			 }
			?></td>
            ...
            <td><?php
			 $respacdoc = mysqli_query("SELECT * FROM testtype where ttypeid='$row1[ttypeid]'");
