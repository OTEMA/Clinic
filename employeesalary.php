...
$resapp = mysqli_query("SELECT * FROM employee");
...
$reccount= mysqli_num_rows($resapp21);
?>
          ...
          while($row1 = mysqli_fetch_array($resapp))
  {
	  ...
	  ?>
          <tr>
			...
			$resapp2 = mysqli_query("SELECT * FROM salary where empid='$row1[empid]'  AND  monthsal BETWEEN '$pm1' AND '$pm2'");
		  ...
		  ?>
           <tr>
            ...
            <td><p>Total <strong>:
                  <font color="#FF0000">
                <?php 
			$resapp21 = mysqli_query("SELECT SUM(salaryamt) FROM salary");
