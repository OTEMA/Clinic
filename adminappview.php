...
$resapp = $con->query("SELECT * FROM appointment where adate ='$datad' AND docid='$_POST[name]'");
?>
...
<div id="container">
  <div class="wrapper">
    <div id="content">
      ...
      <table width="465" border="1" bgcolor="cyan">
        <tr>
          <td width="155"><strong>Name :
       <?php
	    $resdcapp = $con->query("SELECT * FROM doctor");
        ?>
 ...
 ?>          
      ...
      <table width="608" border="1" bgcolor="cyan">
        <tr>
	  ...
	  ?>
          <tr>
            ...
            <td><?php echo $row1["patid"]; 
			 $respac = $con->query("SELECT * FROM patient where patid='$row1[patid]'");
			 ...
			 $respacdoc = $con->query("SELECT * FROM doctor where docid='$row1[docid]'");
