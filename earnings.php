...
<a href="doctoraccount.php"> < < Back </a>
      ...
      <table width="586" border="0" bgcolor="124240">
      ...
      <p>&nbsp;</p>
      <table width="534" border="1"bgcolor="124240">
      <tr>
		  ...
		  $resapp = mysqli_query("SELECT * FROM treatment where docid='$_SESSION[docid]' AND date BETWEEN '$datad1' AND '$datad2'");
          while($row1 = mysqli_fetch_array($resapp))
  {
	  ?>
          <tr>
			...
			$respatrec = mysqli_query("SELECT * FROM appointment where appointid='$row1[appointid]'");
        ...
        <p><strong>Earnings:
<?php
        $restot = mysqli_query("SELECT SUM(treatfee)FROM treatment where docid='$_SESSION[docid]' AND date BETWEEN '$datad1' AND '$datad2'");
...
$dt22 = $datad2." 23:59:59";
      ...
      <form method="post" action="" name="abcd">
        <table width="524" border="1" bgcolor="124240">
          <tr>
            <td width="245"><?php
 ...
 ?>
      ...
      <table width="415" border="1" bgcolor="124240">
          <tr>
            <th height="39" scope="col" align="left">Total Expenses</th>
            <th width="125" scope="col"> 
		<?php

        $restot = mysqli_query("SELECT SUM(expamt) FROM expenses WHERE date BETWEEN '$stdate' AND '$enddate'");
		$exptot =0;
			while($rowtot = mysqli_fetch_array($restot))
 			 {
			$exptot = $rowtot[0]; 
		...
		?></th>
          ...
          <tr>
            ...
            <td align="center"><?php
        $restot11a = mysqli_query("SELECT SUM(salaryamt)FROM salary  where date BETWEEN '$stdate 00:00:00' AND '$enddate 00:00:00'");
		...
		?>
          <tr>
            ...
            <td align="center">&nbsp;
            <?php
        $restot11b = mysqli_query("SELECT * FROM doctor");
