...
$resapp1 = mysqli_query("SELECT * FROM salary ");
$resapp21 = mysqli_query("SELECT * FROM salary where monthsal BETWEEN '$stdate' AND '$enddate'");
...
<div id="container">
 ...
 ?>
      ...
      <br />
      <table width="928" border="1" bgcolor="124240">
        <form method="POST" action="">
            <tr>
        ...
        <tr>
          ...
          while($row1 = mysqli_fetch_array($resapp21))
  {
	  ...
	  ?>
          <tr>
            ...
            <td><?php 
			$resapp2 = mysqli_query("SELECT * FROM employee where empid='$row1[empid]'");
			while($row12 = mysqli_fetch_array($resapp2))
  			{
			echo $row12["empname"];
			?>
			</td>
		  ...
		  ?>
           <tr>
            ...
            <td><p>Total <strong>:
                  <font color="#FF0000">
                <?php 
			$resapp21 = mysqli_query("SELECT SUM(salaryamt) FROM salary  where monthsal BETWEEN '$stdate' AND '$enddate'");
			while($row121 = mysqli_fetch_array($resapp21))
  			{
			echo $row121[0]; 
			}
			?>
