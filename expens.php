...
mysqli_query("DELETE FROM expenses WHERE expensetype='$_GET[expensetype]' AND quantity ='$_GET[quantity]' AND date='$_GET[date]'");
$resapp = mysqli_query("SELECT * FROM expenses where date  BETWEEN '$stdate' AND '$enddate'");
?>
...
<div id="container">
 ...
 ?>
      ...
      <table width="676" border="1" bgcolor="cyan">
        <tr>
