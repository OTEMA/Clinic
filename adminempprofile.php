...
{
	$resrec= mysqli_query("UPDATE employee SET 
...
{
$resultpatientrec = mysqli_query("SELECT * FROM employee WHERE empid ='$_GET[empids]'");
}
else
{
$resultpatientrec = mysqli_query("SELECT * FROM employee WHERE empid ='$_SESSION[empid]'");
}
