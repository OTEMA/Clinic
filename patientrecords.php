...
mysqli_query("DELETE FROM patient WHERE patid = '$_GET[paid]'");
if(isset($_POST["patidbtn"]))
{
$resapp = mysqli_query("SELECT * FROM patient where patid='$_POST[textfield]'");
$_POST[textfield2] ="";
}
else if(isset($_POST["patcontbtn"]))
{
	$resapp = mysqli_query("SELECT * FROM patient where contactno='$_POST[textfield2]'");
		$_POST[textfield]="";
}
else
{
	$resapp = mysqli_query("SELECT * FROM patient");
}
?>
...
<div id="container">
  ...
  &nbsp; <input type="text" name="textfield2" id="textfield2" class="validate[custom[onlyNumberSp]] text-input" value="<?php echo $_POST[textfield2]; ?>"/> &nbsp;
      ...
      <p>&nbsp;</p>
      <table width="1157" border="1" bgcolor="124240">
        <tr>
