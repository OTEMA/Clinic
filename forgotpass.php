        ...
        <div id="content">&nbsp;
            <p>
                ...
                if (isset($_POST["btnlogin"])) {
                    ...
                    $sql = mysqli_query("SELECT * FROM patient WHERE patid = '$_POST[loginid]' AND emailid='$_POST[emailid]' AND dob='$datad'");
                ...
                <p>
                    ...
                    mysqli_query("UPDATE patient SET password = '$_POST[newpass]'
