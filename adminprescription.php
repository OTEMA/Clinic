...
{
	mysqli_query("DELETE FROM medicine WHERE medicine = '$_GET[presdelid]'");
}
...
<table width="1000" border="1" bgcolor="124240">
  <tr bgcolor="#FFFFFF">
    <td width="140"><font color="#0033FF"><b>Medicine</b></font></td>
    
    <td width="500"><font color="#0033FF"><b>Description</b></font></td>
    <td width="58"><font color="#0033FF"><b>Delete</b></font></td>
  </tr>
  <?php
  $resresc = mysqli_query("SELECT * FROM medicine");
