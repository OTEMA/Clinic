...
$resapp = mysqli_query("SELECT * FROM appointment where adate ='$datad' AND docid='$_POST[name]'");
?>
...
<div id="container">
  <div class="wrapper">
    <div id="content">
      ...
      <table width="465" border="1" bgcolor="124240">
        <tr>
 ...
 ?>          
      ...
      <table width="608" border="1" bgcolor="124240">
        <tr>
	  ...
	  ?>
          <tr>
            ...
            <td><?php echo $row1["patid"]; 
			 $respac = mysqli_query("SELECT * FROM patient where patid='$row1[patid]'");
			 ...
			 $respacdoc = mysqli_query("SELECT * FROM doctor where docid='$row1[docid]'");
